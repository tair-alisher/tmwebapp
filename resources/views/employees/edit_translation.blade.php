  ...
  <div class="container news height">
    <div class="row">
      ...
      <div class="col-lg-9 col-md-9 white-background">
        ...
        <hr>
        <p class="text-center"><a href="{{ route('admin.employees.edit_form', $employee->employee_id) }}" target="_blank" class="btn btn-link text-primary">Чтобы изменить <b>email</b>, <b>фото</b>, или <b>дату создания</b>, нажмите здесь</a></p>
        <hr>
